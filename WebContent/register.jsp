        ...
        <div class="ctrlqFormCard">
          ...
          <div class="ctrlqFormContent">
            ...
            <form  method="post" action="register">  
              ...
              <div class="row header">
                <div class="input-field col s12 navbar-collapse" align="center">
                  <h4 style="font-weight: bolder;">FIABCI</h4>
                  <p><center>Event Registration</center> </p>
                </div>
              </div>
              <div class="row">
                <div class="input-field col s12">
                  <select id="title" name="title" class="validate" data-error="#e3" required>    
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="first_name" name="first_name" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="last_name" name="last_name" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
           ...
           <div class="row">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="age" name="age" type="text" class="validate" data-error="#e5">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="job_title" name="job_title" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="industry" name="industry" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
                  <label for="industry">Your Job Industry</label>
                  <div id="e1"></div>
                </div>
              </div>
              <div class="row">
                <div class="input-field col s12">
                  <input id="organization" name="organization" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
                  <label for="organization">Your Job Organization</label>
                  <div id="e1"></div>
                </div>
              </div>
               <div class="row">
                <div class="input-field col s12">
                  <input id="fiabci_membership" name="fiabci_membership" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
                  <label for="fiabci_membership">Your Have Fiabci Membership?</label>
                  <div id="e1"></div>
                </div>
              </div>
               <div class="row">
                <div class="input-field col s12">
                  <input id="type_member" name="type_member" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
                  <label for="type_member">Type Of Fiabci Membership</label>
                  <div id="e1"></div>
                </div>
              </div>
               <div class="row">
                <div class="input-field col s12">
                  <input id="address" name="address" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input id="postal_code" name="postal_code" type="text" class="validate" data-error="#e5">
               ...
               <div class="row">
                <div class="input-field col s12">
                  <input id="city" name="city" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
               ...
               <div class="row">
                <div class="input-field col s12">
                  <input id="country" name="country" pattern="[A-Za-z]{2,}" title="Two or more characters" type="text" class="validate" data-error="#e1" required>
                ...
                <div class="input-field col s12">
                 ...
                 <div class="row">
                <div class="input-field col s12">
                  <input id="mobile" name="mobile" type="text" class="validate" data-error="#e5">
